...
public:
    ...
    ListContainer(const ListContainer& other) : _size{0}, _first{nullptr}, _last{nullptr} {
        Node<T>* other_node = other._first;
        while (other_node) {
            push_back(other_node->value);
